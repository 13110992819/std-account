...
public class JourHistoryBOImpl extends PaginableBOImpl<Jour> implements
    ...
    @Override
    public void doCheckJour(Jour jourHistory, EBoolean checkResult,
            Long checkAmount, String checkUser, String checkNote) {
        Jour data = new Jour();
        data.setCode(jourHistory.getCode());
