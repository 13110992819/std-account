...
import com.std.account.dto.req.XN802417Req;
...
public class XN802417 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        ...
        StringValidater.validateBlank(req.getFromUserId(),
            req.getFromCurrency(), req.getToUserId(), req.getToCurrency(),
            req.getAmount(), req.getTranAmount());
    }
